...
<div class="container" style="min-width: 0; min-height: 0">
  ...
  <div class="collapse show" id="moisture">
    ...
    <div class="row align-items-center mb-4 justify-content-between">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-5 my-4 flex-xs-grow-1 flex-sm-grow-1 flex-md-grow-1">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 my-4 flex-xs-grow-1 flex-sm-grow-1 flex-md-grow-1">
