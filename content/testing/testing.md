...
<div class="container-fluid">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 order-xs-last order-sm-last order-md-first order-lg-first order-xl-first my-4">
      <img class="img-fluid" style="max-width:288px;" src="https://i.imgur.com/zRnrI99.png" alt="testing1">
    </div>
  </div>
  <div class="row align-items-center">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-4">
      <img class="img-fluid" style="max-width:288px;" src="https://i.imgur.com/wGjUPlB.png" alt="testing2">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
